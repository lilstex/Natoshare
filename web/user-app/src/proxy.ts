...
const LOGIN_REQUIRED_ROUTES = ["/onboarding", "/categories", "/dashboard", "/notifications"];
...
export const config = {
  matcher: ["/login", "/signup", "/forgot-password", "/reset-password", "/onboarding", "/categories", "/dashboard", "/notifications"],
};
